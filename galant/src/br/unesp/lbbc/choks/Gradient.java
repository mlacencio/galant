...
public class Gradient
{
     ...
     */
    public final static Color[] GRADIENT_RED_TO_GREEN =  createMultiGradient(new Color[]{Color.RED, Color.BLACK, Color.GREEN}, 1000);
    ...
    /**
     *Produces a gradient through rainbow: violet, blue, green, yellow, orange, red
     */
    public final static Color[] GRADIENT_RAINBOW2 = createMultiGradient(new Color[]{ new Color(51,0,153), Color.blue, Color.cyan, Color.green, Color.yellow, Color.orange,Color.red}, 1000);
